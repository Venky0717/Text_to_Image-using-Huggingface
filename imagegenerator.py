...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.authorization_token = "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"
        ...
        self.windowlabel = ctk.CTkLabel(self, text="Venkatesh Image Generator", text_color="white")
        self.windowlabel.configure(font=font, padx=50, pady=50)
        self.windowlabel.pack(pady=50)
        self.promptlabel = ctk.CTkLabel(self, text="Prompt", text_color="white")
        self.windowlabel.configure(font=font, padx=50, pady=50)
        self.windowlabel.pack(pady=50)
        ...
        self.generatebutton = ctk.CTkButton(master=self,text="Generate Image",width=self.default_window_width-50, height=40,fg_color="#1f1f1f", border_width=2, text_color="white",command=self.generate) 
